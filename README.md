...
In order to decide on the various parameters, I have evaluated these individually by training a new linear SVM classifier for each setting. The accurary on the test set are reported for each parameter setting:
